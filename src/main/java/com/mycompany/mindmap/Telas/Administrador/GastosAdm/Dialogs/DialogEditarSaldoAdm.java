 ...
 * @author felip
 */
public class DialogEditarSaldoAdm extends javax.swing.JDialog {
    ...
    public DialogEditarSaldoAdm(java.awt.Frame parent, boolean modal, Gastos gasto) {
        super(parent, modal);
        initComponents();
...
//        Double saldoNovo = Double.parseDouble(txtSaldo.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogEditarSaldoAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Gastos gasto = null;
                DialogEditarSaldoAdm dialog = new DialogEditarSaldoAdm(new javax.swing.JFrame(), true, gasto);
